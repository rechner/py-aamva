...
class AAMVATestFrame(wx.Frame):
    def __init__(self, *args, **kwargs):
        ...
        hSizer1.Add(self.NameText, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL|wx.EXPAND, 5)
        middleSt = wx.StaticText(self.panel, wx.ID_ANY, "Middle")
        hSizer1.Add(middleSt, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5)
        self.MiddleText = wx.TextCtrl(self.panel, wx.ID_ANY, style=wx.TE_READONLY)
        ...
        self.SurnameText = wx.TextCtrl(self.panel, wx.ID_ANY, style=wx.TE_READONLY)
        ...
        self.AddressText = wx.TextCtrl(self.panel, wx.ID_ANY, style=wx.TE_READONLY)
        ...
        self.Address2Text = wx.TextCtrl(self.panel, wx.ID_ANY, style=wx.TE_READONLY)
        ...
        self.CityText = wx.TextCtrl(self.panel, wx.ID_ANY, style=wx.TE_READONLY)
        ...
        self.StateText = wx.TextCtrl(self.panel, wx.ID_ANY, style=wx.TE_READONLY)
        ...
        self.LicenseNoText = wx.TextCtrl(self.panel, wx.ID_ANY, style=wx.TE_READONLY)
        hSizer6.Add(self.LicenseNoText, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5)
        ...
        self.IssuedText = wx.TextCtrl(self.panel, wx.ID_ANY, style=wx.TE_READONLY)
        ...
        self.ExpiresText = wx.TextCtrl(self.panel, wx.ID_ANY, style=wx.TE_READONLY)
        ...
        self.CountryText = wx.TextCtrl(self.panel, wx.ID_ANY, style=wx.TE_READONLY)
        ...
        self.HeightText = wx.TextCtrl(self.panel, wx.ID_ANY, style=wx.TE_READONLY)
        ...
        self.WeightText = wx.TextCtrl(self.panel, wx.ID_ANY, style=wx.TE_READONLY)
        ...
        self.HairText = wx.TextCtrl(self.panel, wx.ID_ANY, style=wx.TE_READONLY)
        ...
        self.EyesText = wx.TextCtrl(self.panel, wx.ID_ANY, style=wx.TE_READONLY)
        ...
        self.EndorsementsText = wx.TextCtrl(self.panel, wx.ID_ANY, style=wx.TE_READONLY)
        hSizer9.Add(self.EndorsementsText, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5)
        ...
        self.RestrictionsText = wx.TextCtrl(self.panel, wx.ID_ANY, style=wx.TE_READONLY)
        hSizer9.Add(self.RestrictionsText, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5)
    ...
    def ProcessScan(self, evt):
        ...
        self.DOBText.SetValue(str(license['dob']))
        self.AddressText.SetValue(license['address'])
        #~ self.Address2Text.SetValue(license['address2']) #FIXME
        self.CityText.SetValue(license['city'])
        self.StateText.SetValue(license['state'])
        self.ZIPText.SetValue(str(license['ZIP'])[0:5]+"-"+str(license['ZIP'])[5:])
        self.IINText.SetValue(license['IIN'])
        self.LicenseNoText.SetValue(license['licenseNumber'])
        self.IssuedText.SetValue(str(license['issued']))
        self.ExpiresText.SetValue(str(license['expiry']))
        try:
        ...
        self.HeightText.SetValue(str(license['height']))
        self.WeightText.SetValue(str(license['weight']))
...
if __name__ == '__main__':
    ...
    pFrame = AAMVATestFrame(None, title="Scan a License", size=(500, 360))
    pFrame.Show()
    app.MainLoop()
